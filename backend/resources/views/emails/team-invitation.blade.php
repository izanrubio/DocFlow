                ...
                <tr>
                    <td style="padding:32px;">
                        ...
                        <p style="margin:0 0 24px;font-size:15px;color:#4b5563;line-height:1.6;">
                            <strong>{{ $invitation->invitedBy?->name ?? 'Un administrador' }}</strong> te ha invitado a unirte al equipo de
                            <strong>{{ $tenant->name }}</strong> en DocFlow con el rol de
                            ...
                            <tr>
                                <td style="padding:14px 18px;">
                                    <p style="margin:0;font-size:13px;color:#1d4ed8;line-height:1.5;">
                                        ⏰ Esta invitación expira el <strong>{{ $invitation->expires_at->format('d/m/Y') }}</strong>.
                ...
                <tr>
                    <td style="background:#f9fafb;border-top:1px solid #e5e7eb;padding:16px 32px;">
                        <p style="margin:0;font-size:12px;color:#9ca3af;line-height:1.5;">
                            Este email fue enviado automáticamente por DocFlow.
                        </p>
                    </td>
                </tr>
